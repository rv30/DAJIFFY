...
<div >
        <h3>Following</h3>
                <div class="Comentario" style="padding: 0px;">
                    <div class="FotoUsuarioComentario" style="width: 11%;">
                        <img src="user.jpg">
                    </div>
                    <div class="NombreUsuarioComentario" style="width: 80%;">
                        <p>User 3</p>
                    </div>
                    <div id="CheckNotificacion" >
                        <form action="" method="post">    
                        <input type="hidden" name="idUsuarioSeguido" value="">
                        <input type="submit" value="Go to profile" class="nk-btn" name="irPerfilSeguido">
                        </form>
                    </div>
                </div>
