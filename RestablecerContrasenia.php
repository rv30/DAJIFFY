	...
	<nav class="nk-navbar nk-navbar-full nk-navbar-align-center" id="nk-nav-mobile">
        ...
        <div class="Comentario">
            <div id="SeccionSeguridad">
                <b><p style="margin-top: 30px">Type your new password:</p></b>

                <br><br>

                <form name="Correo" action="" method="post">
                    <input type="text" placeholder="Answer" name="Respuesta" title="Respuesta" required style="width:100%"><br><br>
                    <input type="submit" class="nk-btn" value="Next" name="Siguiente" onsubmit="return validar();"
