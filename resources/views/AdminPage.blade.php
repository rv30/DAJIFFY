            ...
            <div class="nk-portfolio-list nk-isotope nk-isotope-3-cols">
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">20 Reports</h2>
                                <div class="portfolio-item-category">User: Juan</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">17 Reports</h2>
                                <div class="portfolio-item-category">User: Rafa</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">10 Reports</h2>
                                <div class="portfolio-item-category">User: Gonzo</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">7 Reports</h2>
                                <div class="portfolio-item-category">User: Mau</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">3 Reports</h2>
                                <div class="portfolio-item-category">User: Kike</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="nk-isotope-item">
                    <div class="nk-portfolio-item nk-portfolio-item-square nk-portfolio-item-info-style-1">
                        ...
                        <div class="nk-portfolio-item-info nk-portfolio-item-info-center text-xs-center">
                            <div>
                                <h2 class="portfolio-item-title h3">1 Reports</h2>
                                <div class="portfolio-item-category">User: Pepe</div>
                            </div>
                        </div>
                    </div>
                </div>
