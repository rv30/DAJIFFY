...
<head>
    ...
    <title>dajiffy | ResetPassword</title>
            ...
            <div class="row vertical-gap">
                <div class="col-lg-12">
                    ...
                    <form action="#" class="nk-form nk-form-ajax">
                        ...
                        <input type="password" class="form-control required" name="title" placeholder="New password"><br>
                        <input type="password" class="form-control required" name="title" placeholder="Confirm password">

                        <div class="nk-gap-1"></div>
                        <div class="nk-form-response-success"></div>
                        <div class="nk-form-response-error"></div>
                        <button class="nk-btn">Save</button>
