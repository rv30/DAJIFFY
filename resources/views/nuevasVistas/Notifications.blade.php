...
<head>
    ...
    <title>dajiffy | Notifications</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h3 class="nk-title">Notifications:</h3>
                        ...
                        <div class="nk-comment">
                            ...
                            <div class="nk-comment-meta">
                                ...
                                <div class="nk-comment-reply"><a href="#">Post</a></div><br>
                                <div class="nk-comment-text"><p>Le ah gustado tu publicacion.</p></div>
                            </div>
                        </div>
                        <!-- END: Comment -->
                        ...
                        <div class="nk-comment">
                            ...
                            <div class="nk-comment-meta">
                                <div class="nk-gap-1"></div>
                                <div class="nk-comment-name"><a href="#">Pepe Rojas</a></div>
                                <div class="nk-comment-reply"><a href="#">Post</a></div><br>
                                <div class="nk-comment-text"><p>A comenzado a seguirte.</p></div>
                            </div>
                        </div>
                        <!-- END: Comment -->
                        ...
                        <div class="nk-comment">
                            ...
                            <div class="nk-comment-meta">
                                <div class="nk-gap-1"></div>
                                <div class="nk-comment-name"><a href="#">Diana Galvan</a></div>
                                <div class="nk-comment-reply"><a href="#">Post</a></div><br>
                                <div class="nk-comment-text"><p>Te comento en una publicación.</p></div>
                            </div>
                        </div>
                        <!-- END: Comment -->
