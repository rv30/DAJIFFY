        ...
        <div class="container" id="contact">
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-lg-7">
                    <div class="nk-gap-4"></div>
                    <!-- START: Form -->
                    <form action="#" class="nk-form nk-form-ajax" id="loginFormulario" v-on:submit.prevent="loginUser" method="post" enctype="multipart/form-data">

                        <input type="email" class="form-control required" name="title" placeholder="Email"><br>
                        <input type="password" class="form-control required" name="title" placeholder="Password">
