                ...
                <div class="col-lg-12">
                    ...
                    <form action="#" class="nk-form nk-form-ajax">
                        <div class="row vertical-gap">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control required" name="message" rows="8" placeholder="Aditional comments" aria-required="true"></textarea>
                            </div>
                        </div>
                        <div class="nk-gap-1"></div>
                        <div class="nk-form-response-success"></div>
                        <div class="nk-form-response-error"></div>
                        <button class="nk-btn">Ban</button>
